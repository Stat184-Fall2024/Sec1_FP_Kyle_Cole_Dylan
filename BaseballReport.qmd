...
players <- read.csv("data/Player.csv")
```
...
# Note: computed pitching bWAR does not take into account the "leverage" factor and also is not adjusting for the ballpark. Thus, searches of the pitching WAR yields slightly different results.
```
