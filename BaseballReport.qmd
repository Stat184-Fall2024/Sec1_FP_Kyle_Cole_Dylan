...
In this section, we outline the methodology used to transform raw data into feature-rich datasets suitable for analysis. This process involved data cleaning, wrangling, and deriving new features from the datasets.

(explain code in data-wrangling block)
